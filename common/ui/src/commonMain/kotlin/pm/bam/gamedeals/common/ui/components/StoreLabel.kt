 ...
 *
 * The leading mark is delegated to [StoreIcon]: a bundled brand logo for the common stores,
 * otherwise the remote [iconUrl] image, otherwise a neutral dot tinted with [color] — so rows stay
