...
val PreviewGiveaway = Giveaway(id = 123, title = "Giveaway Title", worthDenominated = "$100", worth = 100.00, thumbnail = "Thumb", image = "Image", description = "Description", instructions = "Instructions", openGiveawayUrl = "Open Giveaway URL", publishedDate = LocalDateTime(2026, 1, 1, 0, 0), type = GiveawayType.GAME, platforms = listOf(GiveawayPlatform.PC), endDate = "N/A", users = 3463, status = "Active", gamerpowerUrl = "Gamerpower URL", openGiveaway = "Open Giveaway")
