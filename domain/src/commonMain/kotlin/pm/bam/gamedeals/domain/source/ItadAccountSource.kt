...
interface ItadAccountSource {
    ...
    /** The full deal content of a waitlist notification (games + their deals) for the in-app detail screen. */
    suspend fun getWaitlistNotificationDetail(id: String): NotificationDetail
